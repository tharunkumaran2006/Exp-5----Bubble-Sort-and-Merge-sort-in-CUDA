...
<img width="1767" height="335" alt="image" src="https://github.com/user-attachments/assets/d012dff4-648e-44c6-a497-bf8c7ee10a15" />


## RESULT:
Thus, the program has been executed using CUDA to compare CPU and GPU implementations of Bubble Sort and Merge Sort. It is observed that CPU Bubble Sort took 262.975323 milliseconds, GPU Bubble Sort took 129.277054 milliseconds, CPU Merge Sort took 1.810029 milliseconds, and GPU Merge Sort took 401.477631 milliseconds. Hence, for this dataset, the CPU implementation performed faster than the GPU implementation.
